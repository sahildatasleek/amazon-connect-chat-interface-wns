...
export class SystemMessage extends React.PureComponent {
  ...
  getMessageText = () => {
    ...
    let chatWContent = {
      ...
      pl: {
        PARTICIPANT_JOINED: " dołączył do czatu",
        PARTICIPANT_LEFT: " opuścił czat",
        CHAT_ENDED: "Czat został zakończony!",
        PARTICIPANT_IDLE: " stał się nieaktywny",
        PARTICIPANT_DISCONNECT: " był nieaktywny zbyt długo, rozłączanie",
        PARTICIPANT_RETURNED: " wrócił",
      },
    };
